...
export interface ResolveTabDropIntentInput {
...
export function resolveTabDropIntent({ active, pointer, overTargets }: ResolveTabDropIntentInput): TabDropIntent | null {
