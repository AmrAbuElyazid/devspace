...
export default function BrowserPermissionPrompt({
  ...
  return (
    <div className="browser-permission-prompt" role="dialog" aria-label={`${permissionLabel} permission request`}>
      ...
      <p>
        ...
        {' '}
        {permissionLabel.toLowerCase()}.
      </p>
      <div className="browser-permission-actions">
        <Button variant="ghost" size="sm" onClick={onDismiss}>Dismiss</Button>
        <Button variant="outline" size="sm" onClick={() => onDecision('deny')}>Deny</Button>
        <Button variant="secondary" size="sm" onClick={() => onDecision('allow-once')}>Allow once</Button>
        <Button size="sm" onClick={() => onDecision('allow-for-session')}>Allow for session</Button>
      </div>
    </div>
  )
}
