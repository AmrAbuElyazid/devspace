      ...
      <div className="max-w-2xl mx-auto px-6 py-6 space-y-8">
        ...
        <section>
          ...
          <SettingRow label="Scrollback lines">
            <NumberInput value={terminalScrollback} onChange={(v) => updateSetting('terminalScrollback', v)} min={500} max={50000} step={500} />
          </SettingRow>
            ...
            {shortcuts.map((s, i) => (
              <div
                ...
                style={{
                  ...
                  borderBottom: i < shortcuts.length - 1 ? '1px solid var(--border-faint)' : undefined,
                }}
              >
                <span className="text-sm" style={{ color: 'var(--foreground-muted)' }}>{s.action}</span>
                <Kbd>{s.keys}</Kbd>
              </div>
            ))}
          </div>
