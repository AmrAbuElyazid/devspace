...
const cliHttpServer = createHttpServer((req, res) => {
  ...
  if (token !== cliAuthToken) { res.writeHead(403).end('forbidden'); return }
...
function createWindow(): void {
  ...
  registerIpcHandlers(window, terminalManager, browserPaneManager, vscodeServerManager, t3codeServerManager, browserImportService, browserSessionManager)
